...
//        if (!gameOver) {
//            if (updateHUD) {
//                StdDraw.textLeft( Engine.WIDTH / 8, Engine.HEIGHT / 8, "Type");
//            } else {
//                StdDraw.textLeft(Engine.WIDTH / 8, Engine.HEIGHT / 88, "Watch!");
//            }
//            StdDraw.line(0, Engine.HEIGHT -5, Engine.WIDTH, Engine.HEIGHT - 5);
//        }
